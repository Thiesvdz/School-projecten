...
def verhaalstuk15():
    os.system("cls")
    print("Je bent uitgestapt en gaat bedenken wat je kan gaan doen, voordat je het weet wordt je opgepakt door ISIS./n je wordt geforceerd om te vechten voor hen")
...
def verhaalstuk20():
    os.system("cls")
    print("Je maakt het veilig naar europa, daar kan je een veilig en gelukkig leven te gemoet gaan")
...
def verhaalstuk21():
    os.system("cls")
    print("Je gaat rechtdoor en na een lange reis eindig je veiling in een vluchtelingenkamp")
    Enterknop()
